-- Add missing medical_records table
...
CREATE TABLE IF NOT EXISTS medical_records (
    ...
    record_type VARCHAR(50) NOT NULL CHECK (record_type IN ('diagnosis', 'prescription', 'lab_result', 'imaging', 'vaccination', 'allergy', 'surgery', 'other')),
